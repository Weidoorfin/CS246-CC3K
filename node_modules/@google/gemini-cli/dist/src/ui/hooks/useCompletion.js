        ...
        if (trimmedQuery.startsWith('/')) {
            ...
            if (!hasTrailingSpace) {
                if (leafCommand && partial === '' && leafCommand.action) {
                    ...
                    const perfectMatch = currentLevel.find((cmd) => (cmd.name === partial || cmd.altName === partial) && cmd.action);
                    if (perfectMatch) {
                        setIsPerfectMatch(true);
                    }
                }
            ...
            if (commandsToSearch.length > 0) {
                ...
                if (potentialSuggestions.length > 0 && !hasTrailingSpace) {
                    const perfectMatch = potentialSuggestions.find((s) => s.name === partial || s.altName === partial);
