...
import { loadSettings, USER_SETTINGS_PATH, SettingScope, } from './config/settings.js';
...
import { ApprovalMode, EditTool, ShellTool, WriteFileTool, sessionId, logUserPrompt, AuthType, getOauthClient, shouldAttemptBrowserLaunch, } from '@google/gemini-cli-core';
...
export async function main() {
    ...
    const nonInteractiveConfig = await loadNonInteractiveConfig(config, extensions, settings, argv);
